    ...
    <footer className="border-t border-[#E6C280]/20 relative overflow-hidden bg-[#121213]">
      ...
      <div className="py-10 sm:py-20 md:py-28 max-w-[1400px] mx-auto px-5 sm:px-12 md:px-16 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-4 flex flex-col items-start pr-0 lg:pr-8">
            <Link href="/" className="inline-block mb-5 lg:mb-8 cursor-pointer">
            ...
            <p className="font-serif italic text-xs lg:text-sm text-[#FFFBF4]/70 leading-relaxed mb-5 lg:mb-8">
            ...
            <div className="font-body text-xs leading-relaxed text-[#FFFBF4]/50 mb-5 lg:mb-8">
              <h5 className="font-accent text-[9.5px] tracking-[0.25em] uppercase text-[#E6C280] mb-2">Mumbai Atelier</h5>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 lg:w-12 lg:h-12 rounded-full border border-[#E6C280]/20 flex items-center justify-center text-[#E6C280] hover:text-[#121213] hover:bg-[#E6C280] hover:border-[#E6C280] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(230,194,128,0.4)] cursor-pointer"
          ...
          <div className="hidden lg:block lg:col-span-2">
            <h4 className="font-serif text-lg tracking-[0.2em] uppercase text-[#E6C280] mb-8">Collections</h4>
            <ul className="flex flex-col gap-4">
              {collectionsLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    href={l.href}
                    className="relative py-1 block text-base text-[#FFFBF4]/70 hover:text-[#E6C280] transition-colors duration-300 group max-w-max cursor-pointer"
                  >
                    {l.label}
          ...
          {/* Mobile Accordion */}
          <div className="block lg:hidden w-full border-b border-[#E6C280]/15 py-1">
            <button
            ...
            <AnimatePresence initial={false}>
              {openSection === "collections" && (
                <motion.ul
                  ...
                  className="flex flex-col gap-2 overflow-hidden pb-3 pl-2"
                >
                  {collectionsLinks.map((l) => (
                    <li key={l.label}>
                      <Link
          ...
          {/* Desktop Link Grid */}
          <div className="hidden lg:block lg:col-span-2">
            <h4 className="font-serif text-lg tracking-[0.2em] uppercase text-[#E6C280] mb-8">Customer Care</h4>
            <ul className="flex flex-col gap-4">
          ...
          <div className="lg:col-span-4 flex flex-col items-start w-full">
            <h4 className="font-serif text-sm lg:text-lg tracking-[0.2em] uppercase text-[#E6C280] mb-4 lg:mb-8">Atelier Services</h4>
            ...
            <div className="w-full">
              <h5 className="font-accent text-[10px] tracking-[0.2em] uppercase text-[#E6C280] mb-2">Atelier Newsletter</h5>
              <p className="font-serif italic text-xs text-[#FFFBF4]/60 mb-3 leading-relaxed lg:mb-6">
              ...
              <form onSubmit={handleSubscribe} className="w-full flex flex-col sm:flex-row gap-3">
                <div className="relative flex-grow w-full">
                  <input
                    ...
                    className="w-full bg-[#1A1A1B] text-[#FFFBF4] text-sm font-body placeholder-[#FFFBF4]/30 focus:outline-none border border-[#E6C280]/20 focus:border-[#E6C280] focus:ring-2 focus:ring-[#E6C280]/20 rounded-[16px] px-5 h-[52px] transition-all duration-[250ms] ease-[cubic-bezier(0.22,1,0.36,1)]"
                  />
                </div>
      ...
      <div className="border-t border-[#E6C280]/10 bg-[#0e0e10] py-5 lg:py-8 relative z-10">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-12 md:px-16 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="font-accent text-[9px] tracking-[0.18em] text-[#FFFBF4]/30 flex items-center gap-1.5">
