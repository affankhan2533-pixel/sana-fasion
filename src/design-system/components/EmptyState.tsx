...
export default function EmptyState({ icon, title, description, children, className = '' }: EmptyStateProps) {
  return (
    <div className={cn("bg-white border border-[#E6C280]/15 rounded-[12px] p-8 text-center flex flex-col items-center justify-center gap-4 text-[#9B8E7E] shadow-sm max-w-md mx-auto animate-fade-in", className)}>
