    ...
    <div ref={ref}>
      ...
      <div className="relative overflow-hidden" style={{ minHeight: "380px", background: "linear-gradient(135deg, #8B1A3A 0%, #5C1020 40%, #2E0D1A 100%)" }}>
        ...
        <motion.div
          ...
          variants={stagger}
          className="relative z-10 editorial-container section-spacing text-center"
        >
          <motion.span variants={up} className="eyebrow-text text-[#FAD5B5]/95 mb-4">
            The Sana Promise
          </motion.span>
          <motion.h2
            variants={up}
            className="section-title-text text-white mb-6 mx-auto"
            style={{ maxWidth: "800px" }}
          >
            Designed to Make Every <span className="italic font-normal text-gold">Occasion Unforgettable</span>
          </motion.h2>
          <motion.p
            variants={up}
            className="body-text-standard mb-8 mx-auto max-w-lg"
          ...
          <motion.div variants={up} className="flex flex-wrap gap-4 justify-center">
      ...
      {/* Contact Form */}
      <div id="contact-form" className="section-spacing bg-[#FFF5E6]">
        <div className="editorial-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              <span className="eyebrow-text text-gold mb-4">Get in Touch</span>
              <h3 className="section-title-text mb-6" style={{ color: "var(--ink)" }}>
                Begin Your <span className="italic font-normal text-gold">Fashion Journey</span>
              </h3>
              <div className="divider-line mb-8" />
              <p className="body-text-standard text-text-muted mb-8">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={item.label} className="vintage-card p-5">
                    <span className="eyebrow-text text-gold mb-2">{item.label}</span>
                    <a href={item.href} target="_blank" rel="noopener noreferrer" className="underline-grow font-body text-base text-text-secondary">
                      {item.val}
                    </a>
                  </div>
                ))}
            ...
            >
              {done ? (
                ...
                >
                  ...
                  <p className="body-text-standard text-text-secondary max-w-xs">
